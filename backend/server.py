        ...
        messages=[{
            ...
            "content": [
                ...
                {"type": "text", "text": (
                    ...
                    "item as one of these, OMIT it (never guess or invent). If the photo does not clearly "
                    "show real food ingredients (blank, blurry, dark, or unrelated), return an EMPTY items "
                    "list — do not force matches. For each visible item give a "
